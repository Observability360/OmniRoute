...
test("Claude CLI wire versions match the captured 2.1.281 binary", () => {
  assert.equal(canonical.CLAUDE_CODE_CLIENT_VERSION, "2.1.281");
  assert.equal(canonical.CLAUDE_CODE_CLIENT_BUILD_REVISION, "407");
  assert.equal(canonical.CLAUDE_CODE_CLIENT_BILLING_VERSION, "2.1.281.407");
